...
class MemoriesResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> MemoriesResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/evermemosclient-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> MemoriesResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/evermemosclient-python#with_streaming_response
        """
